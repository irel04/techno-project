    ...
    <main className="flex flex-col items-center justify-center">
      <section className="w-full md:w-3/4 lg:w-1/2 px-4">
        ...
        <div className="my-4 text-justify">
          <p>
            This Privacy Policy describes how [Your Company Name] collects,
            uses, and discloses personal information when you use our website
            [Your Website URL] (the "Site").
          </p>
        </div>
        ...
        <div className="my-4 text-justify">
          ...
          <ul className="list-disc list-inside">
            ...
            <p>
              ...
              mind at any time by writing to or emailing us at [Your Contact
              Email Address].
            </p>
          </ul>
        </div>
        ...
        <div className="my-4 text-justify">
          ...
          <p>
            ...
            about a child under 13, please contact us at [Your Contact Email
            Address].
          </p>
        </div>
        ...
        <div className="my-4 text-justify">
          ...
          <p>
            ...
            us by email at [Your Contact Email Address].
          </p>
        </div>
      </section>
    </main>
